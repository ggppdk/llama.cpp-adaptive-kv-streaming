...
template<int DKQ, int DV, int ncols1, int ncols2, int nwarps, bool use_logit_softcap, bool V_is_K_view, bool needs_fixup, bool is_fixup, bool output_partial>
...
template<int DKQ, int DV, int ncols1, int ncols2, bool use_logit_softcap, bool V_is_K_view, bool output_partial = false>
...
static __global__ void flash_attn_ext_f16(
    ...
    while (kbc < kbc_stop && kb0_stop == iter_k) {
        ...
        if (kb0_start == 0) {
            ...
            flash_attn_ext_f16_process_tile<DKQ, DV, ncols1, ncols2, nwarps, use_logit_softcap, V_is_K_view, needs_fixup, is_fixup, output_partial>
                (Q_f2, K_h2, V_h2, mask_h, sinks_f, dstk, dst_meta_tile, scale, slope, logit_softcap,
...
static void ggml_cuda_flash_attn_ext_mma_f16_case_impl(
    ...
    if (logit_softcap == 0.0f) {
        ...
        fattn_kernel = flash_attn_ext_f16<DKQ, DV, ncols1, ncols2, use_logit_softcap, V_is_K_view, output_partial>;
    ...
    launch_fattn<DV, ncols1, ncols2>
        (ctx, dst, fattn_kernel, nwarps, nbytes_shared_total, nbatch_fa, true, true,
         !output_partial, warp_size_host, partial_dst, partial_meta);
}
